...
const ProjectsPage = () => {
  return (
    <section 
      className="section bg-[var(--projects-background)] transition-all duration-300 flex justify-center overflow-hidden"
      style={{ width: '100%', maxWidth: '100%' }}
    >
      <div className="component w-[90%] max-w-[800px] min-h-[60vh] md:min-h-[90vh] flex flex-col justify-between p-[0.5rem] md:p-[2rem]">
        <div>
